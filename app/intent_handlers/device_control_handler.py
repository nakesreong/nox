...
def handle_device_control(entities: dict) -> dict:
    ...
    if target_device == "light":
        ...
        if action == "turn_on":
            ...
            result = light_actions.turn_on(brightness_percent=brightness_pct, kelvin=final_kelvin_to_set)
            ...
            return {
                "success": False,
                "details_or_error": f"Unknown action '{action}' for light.",
                "action_performed": "unknown_light_action",
            }
        ...
        if result and result.get("success"):
            return {
                ...
                # Keep location if NLU provided it
